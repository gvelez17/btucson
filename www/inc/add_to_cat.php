...
<FORM action="/cgi/blogform.pl" onsubmit="return verify_captcha(this)" method=post>
...
<?
if (!isset($_SESSION['user'])) {
        print 'Guest posts welcome - if you are a human, please finish this line: <i>Humpty Dumpty sat on a <input name="human_check_1" size=4 maxlength=4></i><br/>';
        print "<input type=hidden name=logged_in_user value=0>";
} else {
        print "<input type=hidden name=logged_in_user value=1>";
}
?>
